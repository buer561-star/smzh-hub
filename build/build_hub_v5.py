...
FLAGSHIP_LP={
 'hypothekenradar':{
  ...
  'about_p':'Der Hypotheken-Radar erscheint monatlich und ordnet das Zinsumfeld für private Hypothekarnehmerinnen und Hypothekarnehmer ein – verständlich und ohne Verkaufslogik. Jede Ausgabe verfolgt die Erwartung an die nächste SNB-Lagebeurteilung, das Niveau der Festhypothekarsätze und die Frage, wann sich SARON oder eine feste Laufzeit anbietet. Die Reihe richtet sich an alle, die vor einem Abschluss, einer Verlängerung oder einer Umschuldung stehen und eine fundierte Grundlage suchen statt Schlagzeilen. Wer regelmässig mitliest, erkennt Zinsbewegungen früh – und entscheidet auf Basis von Einordnung statt aus dem Bauch heraus.',
  ...
  'cta_p':'Ob Erstabschluss, auslaufende Festhypothek oder Umschuldung – wir ordnen Ihre Tragbarkeit, Zinsstrategie und Laufzeiten für Ihre Situation ein und zeigen die nächsten Schritte. Unabhängig und auf Basis des laufenden Research hinter dem Hypotheken-Radar.',
 ...
 'immobilien-outlook':{
  ...
  'cta_p':'Ob Kaufentscheid, Eigenkapitalplanung oder die Frage, ob Sie halten oder umschichten – wir ordnen Ihre Situation vor dem Hintergrund von Marktlage und Tragbarkeit ein und zeigen die nächsten Schritte. Unabhängig und auf Basis des Research hinter dem Immobilien-Outlook.',
